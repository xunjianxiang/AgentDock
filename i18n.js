...
const rows = [
  ...
  ,["探索发现", "探索發現", "Explore", "探索", "Entdecken"]
  ,["搜索和安装 Skills", "搜尋和安裝 Skills", "Search and install Skills", "Skills を検索してインストール", "Skills suchen und installieren"]
  ,["打开 GitHub 仓库", "開啟 GitHub 儲存庫", "Open GitHub repository", "GitHub リポジトリを開く", "GitHub-Repository öffnen"]
  ,["默认安装位置", "預設安裝位置", "Default installation location", "既定のインストール先", "Standardinstallationsort"]
  ,["同时启用到其他客户端", "同時啟用至其他客戶端", "Also enable for other clients", "他のクライアントでも有効にする", "Auch für andere Clients aktivieren"]
  ,["没有其他可选客户端", "沒有其他可選客戶端", "No other optional clients", "他に選択できるクライアントはありません", "Keine weiteren optionalen Clients"]
  ,["已安装", "已安裝", "Installed", "インストール済み", "Installiert"]
  ,["安装位置", "安裝位置", "Installations", "インストール先", "Installationsorte"]
  ,["卸载", "解除安裝", "Uninstall", "アンインストール", "Deinstallieren"]
  ,["卸载全部", "全部解除安裝", "Uninstall all", "すべてアンインストール", "Alle deinstallieren"]
  ,["确认卸载", "確認解除安裝", "Confirm uninstall", "アンインストールを確認", "Deinstallation bestätigen"]
  ,["已启用的客户端", "已啟用的客戶端", "Enabled clients", "有効なクライアント", "Aktivierte Clients"]
  ,["可启用的客户端", "可啟用的客戶端", "Available clients", "有効化できるクライアント", "Verfügbare Clients"]
  ,["正在读取可启用目录", "正在讀取可啟用目錄", "Loading available locations", "利用可能な場所を読み込み中", "Verfügbare Speicherorte werden geladen"]
  ,["本机没有可安装 Skills 的 Agent 客户端", "本機沒有可安裝 Skills 的 Agent 客戶端", "No local Agent client can install Skills", "Skills をインストールできる Agent クライアントがありません", "Kein lokaler Agent-Client kann Skills installieren"]
  ,["Skill 文件", "Skill 檔案", "Skill files", "Skill ファイル", "Skill-Dateien"]
  ,["只读", "唯讀", "Read only", "読み取り専用", "Schreibgeschützt"]
  ,["选择文件来源", "選擇檔案來源", "Choose file source", "ファイルの取得元を選択", "Dateiquelle auswählen"]
  ,["正在读取 Skill 文件", "正在讀取 Skill 檔案", "Loading Skill files", "Skill ファイルを読み込み中", "Skill-Dateien werden geladen"]
  ,["没有可展示的文件", "沒有可顯示的檔案", "No files to display", "表示できるファイルがありません", "Keine Dateien zum Anzeigen"]
  ,["Skill 文件列表", "Skill 檔案清單", "Skill file list", "Skill ファイル一覧", "Skill-Dateiliste"]
  ,["正在读取文件", "正在讀取檔案", "Loading file", "ファイルを読み込み中", "Datei wird geladen"]
  ,["无法预览该文件", "無法預覽此檔案", "This file cannot be previewed", "このファイルはプレビューできません", "Diese Datei kann nicht angezeigt werden"]
  ,["本地复制", "本機複製", "local copy", "ローカルコピー", "lokale Kopie"]
  ,["Skill 已通过 {method} 启用", "Skill 已透過 {method} 啟用", "Skill enabled via {method}", "Skill を {method} で有効化しました", "Skill wurde über {method} aktiviert"]
  ,["尚未安装 Skills", "尚未安裝 Skills", "No Skills installed", "Skills はまだインストールされていません", "Noch keine Skills installiert"]
  ,["{name} 已卸载", "{name} 已解除安裝", "{name} uninstalled", "{name} をアンインストールしました", "{name} wurde deinstalliert"]
  ,["该 Skill 已从所选 Agent 中卸载。", "此 Skill 已從所選 Agent 中解除安裝。", "This Skill was uninstalled from the selected Agents.", "この Skill は選択した Agent からアンインストールされました。", "Dieser Skill wurde von den ausgewählten Agents deinstalliert."]
  ,["confirm.uninstallSkillInstallationMessage", "將解除安裝 {name} 的這個安裝位置：\n{path}\n受影響 Agent：{agents}", "This installation of {name} will be uninstalled:\n{path}\nAffected Agents: {agents}", "{name} のこのインストール先を削除します：\n{path}\n対象 Agent：{agents}", "Diese Installation von {name} wird entfernt:\n{path}\nBetroffene Agents: {agents}"]
  ,["confirm.uninstallSkillAgentsMessage", "將從以下 Agent 解除安裝 {name}：{agents}", "{name} will be uninstalled from these Agents: {agents}", "{name} を次の Agent からアンインストールします：{agents}", "{name} wird von diesen Agents deinstalliert: {agents}"]
  ,["confirm.uninstallAllSkillMessage", "將解除安裝 {name} 的 {count} 個安裝位置。", "All {count} installations of {name} will be uninstalled.", "{name} の {count} 件のインストールをすべて削除します。", "Alle {count} Installationen von {name} werden entfernt."]
  ,["confirm.uninstallDependentPaths", "為保留其他安裝位置，以下連結會先轉為獨立副本：\n{paths}", "To preserve other installations, these links will first become independent copies:\n{paths}", "他のインストールを保持するため、次のリンクを独立したコピーに変換します：\n{paths}", "Um andere Installationen zu erhalten, werden diese Links zuerst in unabhängige Kopien umgewandelt:\n{paths}"]
